...
from app.api import account, admin, auth, cms, communications, employer, files, inbound, payments, portal, portfolio, public, school_feedback, school_skills, school_transfers, schools, workflows
...
for r in (auth.router, public.router, portal.router, admin.router, admin.agents_router, files.router, workflows.router, payments.router, cms.router, communications.router, inbound.router, account.router, employer.router, schools.router, school_transfers.coordinator_router, school_transfers.admin_router, portfolio.router, school_skills.router, school_feedback.coordinator_router, school_feedback.admin_router):
