...
from app.api import account, admin, auth, cms, communications, employer, files, inbound, payments, portal, public, school_skills, school_transfers, schools, workflows
...
for r in (auth.router, public.router, portal.router, admin.router, admin.agents_router, files.router, workflows.router, payments.router, cms.router, communications.router, inbound.router, account.router, employer.router, schools.router, school_transfers.coordinator_router, school_transfers.admin_router, school_skills.router):
