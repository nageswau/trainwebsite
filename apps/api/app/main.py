...
from app.api import account, admin, auth, cms, communications, employer, files, inbound, payments, portal, portfolio, public, school_skills, school_student_profile, school_transfers, schools, student_360, workflows
...
for r in (auth.router, public.router, portal.router, admin.router, admin.agents_router, files.router, workflows.router, payments.router, cms.router, communications.router, inbound.router, account.router, employer.router, schools.router, school_transfers.coordinator_router, school_transfers.admin_router, portfolio.router, school_skills.router, student_360.router, school_student_profile.router):
